    ...
    <div class="container px-4 py-2">
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
            <div class="scenario-description">Exercise 2.2: Clustering Columns</div>
            <ul>
            ...
            <ul>
              ...
              <li><span class="scenario-objective">Create a new table that allows range scans and ordering by year</span></li>
              <li><span class="scenario-objective">Load data into the table from a CSV file</span></li>
            </ul>
      </div>
     </div>
    </div>
